...
@pytest.mark.feature("ssh and not (aws or azure)", reason="We want no authorized_keys for unmanaged users")
...
@pytest.mark.feature("ssh and (aws or azure)", reason="AWS and Azure auto generate authorized_keys for root with a hint to use another user")
