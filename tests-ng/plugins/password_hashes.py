...
@pytest.fixture
def pam_config(request: pytest.FixtureRequest) -> PamConfig:
    """
    Return a PamConfig object for the requested pam configuration file. 
    request.param is passed as indirect argument via indirect parameter:
