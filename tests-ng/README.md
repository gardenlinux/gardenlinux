...
- **`.build/dist.raw`**: Raw ext2 filesystem image for mounting in VMs
- **`.build/dist.raw.tar.gz`**: Compressed tar file including [`disk.raw`](https://cloud.google.com/compute/docs/import/import-existing-image) Raw ext2 filesystem image to import to GCP
