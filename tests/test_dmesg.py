...
@pytest.mark.setting_ids(["GL-SET-gardener-config-sysctl-allow-nonroot-dmesg"])
...
@pytest.mark.setting_ids(
    [
        "GL-SET-server-config-sysctl-restrict-dmesg",
    ]
)
...
@pytest.mark.setting_ids(["GL-SET-stig-config-sysctl-stig"])
...
@pytest.mark.setting_ids(
    [
        "GL-SET-gardener-config-sysctl-allow-nonroot-dmesg",
    ]
)
@pytest.mark.feature("gardener")
...
@pytest.mark.setting_ids(
    [
        "GL-SET-stig-config-sysctl-stig",
    ]
)
@pytest.mark.feature("stig")
@pytest.mark.booted(reason="sysctl needs a booted system")
