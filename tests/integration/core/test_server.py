...
@pytest.mark.setting_ids(
    [
        "GL-SET-kvm-config-no-vmlinuz",
        "GL-SET-kvm-config-no-vmlinuz-old",
...
@pytest.mark.setting_ids(
    [
        "GL-SET-server-config-cron-no-e2scrub_all",
    ]
)
@pytest.mark.feature("server")
...
@pytest.mark.setting_ids(
    [
        "GL-SET-server-config-kernel-img-conf",
    ]
)
@pytest.mark.feature("server")
...
@pytest.mark.setting_ids(
    [
        "GL-SET-server-config-systemd-system-conf-server",
    ]
)
@pytest.mark.feature("server")
...
@pytest.mark.setting_ids(
    [
        "GL-SET-server-config-systemd-system-dbus-socket",
    ]
)
@pytest.mark.feature("server")
...
@pytest.mark.setting_ids(
    [
        "GL-SET-server-config-update-motd-no-uname",
    ]
)
@pytest.mark.feature("server")
