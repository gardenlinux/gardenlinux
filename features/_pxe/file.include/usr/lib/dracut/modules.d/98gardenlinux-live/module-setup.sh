...
install() {
    ...
    inst_script "$moddir/ignition-extra-fetch.sh" /sbin/ignition-extra-fetch
    ...
    inst_simple "$moddir/ignition-extra-fetch.conf" /etc/systemd/system/ignition-fetch.service.d/ignition-extra-fetch.conf
