...
github_target_path: docs/reference/releases/release-notes/index.md
---

# Release Notes

Garden Linux release notes sourced from GitHub. Select a version below to view its release notes.
