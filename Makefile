...
aws:
	...
	./scripts/makef.sh --grub-target bios --force .build/aws/aws .build/aws/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
aws-dev:
	...
	./scripts/makef.sh --grub-target bios --force .build/aws-dev/aws-dev .build/aws-dev/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
aws-chost-dev:
	...
	./scripts/makef.sh --grub-target bios --force .build/aws-chost-dev/aws-chost-dev .build/aws-chost-dev/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
gcp:
	...
	./scripts/makef.sh --grub-target bios --force .build/gcp/gcp .build/gcp/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
gcp-dev:
	...
	./scripts/makef.sh --grub-target bios --force .build/gcp-dev/disk .build/gcp-dev/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
azure:
	...
	./scripts/makef.sh --grub-target bios --force .build/azure-dev/azure .build/azure/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
azure-dev:
	...
	./scripts/makef.sh --grub-target bios --force .build/azure-dev/azure-dev .build/azure-dev/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
...
openstack:
	...
	./scripts/makef.sh --grub-target bios --force .build/openstack/openstack .build/openstack/$(SNAPSHOT_DATE)/amd64/bullseye/rootfs.tar.xz
